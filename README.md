...
## Режим демонстрации приложения

Режим демонстрации приложения позволит вам увидеть работу сервиса, как она выглядела бы после некоторого времени 
...
* __TEST_MODE=false__ - если установить значение __true__, сервис после запуска заполнит базу данных случайными 
